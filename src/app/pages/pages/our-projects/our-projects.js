				...
				<div class="single-area de-padding">
					<div class="container">
						<div class="single-page-info">
							<aside class="sidebar wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".5s">
								<!--Categories-->
							...
							<div class="case-wpr grid-2 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
								<div class="case-box">
									<div class="case-pic">
									...
									<div class="case-info">
										<span class="d-block l-h-1 fz-16 mb-20">
											<a href="#">Business</a> / <a href="#">Business Analysis</a>
										</span>
										<a href="#">
											<h5 class="mb-0 fz-20 l-h-1">Business Ananlysis & Strategy</h5>
										</a>
									</div>
								</div>
								<div class="case-box">
